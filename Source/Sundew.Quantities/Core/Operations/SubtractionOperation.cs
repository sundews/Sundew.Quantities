...
namespace Sundew.Quantities.Core.Operations
{
    ...
    /// <summary>
    /// Operation for subtracting two <see cref="IQuantity"/> instances.
    /// </summary>
    public class SubtractionOperation : IQuantityOperation<IQuantity>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubtractionOperation" /> class.
        /// </summary>
        /// <param name="valueFromBaseVisitor">From base visitor.</param>
        /// <param name="valueToBaseVisitor">To base visitor.</param>
        public SubtractionOperation(ValueFromBaseVisitor valueFromBaseVisitor, ValueToBaseVisitor valueToBaseVisitor)
        {
        ...
        public IQuantity Execute(IQuantity lhs, IQuantity rhs)
        {
            ...
            throw new UnitMismatchException(OperationType.Subtract, lhsUnit, rhsUnit);
        }
    }
}