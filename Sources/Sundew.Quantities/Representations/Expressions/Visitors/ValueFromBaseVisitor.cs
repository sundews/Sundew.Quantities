// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueFromBaseVisitor.cs" company="Hukano">
...
namespace Sundew.Quantities.Representations.Expressions.Visitors
{
    ...
    /// <summary>
    /// Converts a base unit value into the target <see cref="Expression"/> unit value.
    /// </summary>
    public class ValueFromBaseVisitor : IExpressionVisitor<double, Reference<double>, double>
    {
        ...
        /// <returns>The target <see cref="Expression"/> value.</returns>
        ...
        {
            currentResult.Value = unitExpression.Unit.FromBase(value);
        }
