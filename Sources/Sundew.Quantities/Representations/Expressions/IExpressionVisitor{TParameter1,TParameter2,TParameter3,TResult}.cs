...
namespace Sundew.Quantities.Representations.Expressions
{
    ...
    /// <summary>
    /// Interface for implementing the an expression visitor with three parameters.
    /// </summary>
        ...
        IVisitor<Expression, TParameter1, TParameter2, TParameter3, TResult>
    {
        ...
        /// <param name="parameter2">The parameter2.</param>
        /// <param name="parameter3">The parameter3.</param>
        void Unit(UnitExpression unitExpression, TParameter1 parameter1, TParameter2 parameter2, TParameter3 parameter3);
