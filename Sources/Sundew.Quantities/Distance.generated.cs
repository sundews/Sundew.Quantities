...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Distance.generated.cs" company="Hukano">
...
namespace Sundew.Quantities
{
    ...
    public partial struct Distance : IQuantity<Distance, DistanceUnitSelector>
    {
        ...
        public Distance(double value, SelectUnit<DistanceUnitSelector> unitSelector)
        ...
        public Distance(double value, IUnit unit)
        {
            this.value = value;
            this.Unit = unit;
        }
        ...
        /// </returns>
        public static Distance operator +(Distance quantity)
        {
            return quantity;
        }
        ...
        public static Distance operator -(Distance quantity)
        {
            return new Distance(-quantity.value, quantity.Unit);
        }

        /// <summary>
        /// Increaments the specified <see cref="Distance"/>.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        /// An increamented <see cref="Distance"/>.
        /// </returns>
        public static Distance operator ++(Distance quantity)
        {
            return new Distance(quantity.value + 1, quantity.Unit);
        }

        /// <summary>
        /// Decreaments the specified <see cref="Distance"/>.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        /// An decreamented <see cref="Distance"/>.
        /// </returns>
        public static Distance operator --(Distance quantity)
        {
            return new Distance(quantity.value - 1, quantity.Unit);
        ...
        {
            return new Distance(lhs.value + rhs, lhs.Unit);
        }
        ...
        {
            return new Distance(QuantityOperations.Add(lhs, rhs));
        }
        ...
        public static Distance operator -(Distance lhs, Distance rhs)
        {
            return new Distance(QuantityOperations.Subtract(lhs, rhs));
        }
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="Squared{Distance}"/>.
        /// </returns>
        public Squared<Distance> Squared()
        {
            return new Squared<Distance>(this);
        }
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="Cubed{Distance}"/>.
        /// </returns>
        public Cubed<Distance> Cubed()
        {
            return new Cubed<Distance>(this);
        }
        ...
        /// <summary>
        /// Converts this object to a <see cref="Distance" /> using the specified unit.
        /// </summary>
        /// <param name="unit">The quantity unit.</param>
        /// <returns>
        /// The converted <see cref="Distance" />.
        /// </returns>
        public Distance ToUnit(IUnit unit)
        {
            return new Distance(this.ToDouble(unit), unit);
        }

        /// <summary>
        /// Converts this object to a <see cref="Distance" /> using the unit specified by the <see cref="DistanceUnitSelector" />.
        /// </summary>
        /// <param name="unitSelector">The unit selector.</param>
        /// <returns>
        /// The converted <see cref="Distance" />.
        /// </returns>
        public Distance ToUnit(SelectUnit<DistanceUnitSelector> unitSelector)
        {
            return this.ToUnit(UnitBuilder.BuildUnit(unitSelector(new DistanceUnitSelector())));
        }

        /// <summary>
        /// Converts this object to a <see cref="double" /> using the unit specified by the <see cref="DistanceUnitSelector" />.
        /// </summary>
        /// <param name="unitSelector">The unit selector.</param>
        /// <returns>
        /// The converted <see cref="double" />.
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Distance" />, is equal to this instance.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        ///   <c>true</c> if the specified <see cref="Distance" /> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(Distance quantity)
        {
            return QuantityHelper.AreEqual(this, quantity);
        }
        ...
        {
            return QuantityHelper.CompareTo<Distance>(this, obj);
        }
        ...
        /// A value that indicates the relative order of the objects being compared. The return value has these meanings: Value Meaning Less than zero This instance precedes <paramref name="quantity" /> in the sort order. Zero This instance occurs in the same position in the sort order as <paramref name="quantity" />. Greater than zero This instance follows <paramref name="quantity" /> in the sort order.
        /// </returns>
        public int CompareTo(Distance quantity)
        {
            return QuantityHelper.CompareTo(this, quantity);
        }
        ...
        /// A <see cref="Distance" />.
        /// </returns>
        public Distance CreateQuantity(double value, IUnit unit)
        {
        ...
        /// A unit selector.
        /// </returns>
        DistanceUnitSelector IQuantity<Distance, DistanceUnitSelector>.CreateUnitSelector()
        {
