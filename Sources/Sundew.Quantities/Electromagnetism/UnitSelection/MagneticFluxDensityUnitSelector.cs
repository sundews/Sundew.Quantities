namespace Sundew.Quantities.Electromagnetism.UnitSelection
{
    ...
    /// </summary>
    public class MagneticFluxDensityUnitSelector : PrefixSelector<IMagneticFluxDensityUnitSelector, IPrefixSelector<IMagneticFluxDensityUnitSelector>>, IMagneticFluxDensityUnitSelector
    {
        /// <summary>
        /// Gets the base unit.
        /// </summary>
