...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Angle.generated.cs" company="Hukano">
...
namespace Sundew.Quantities
{
    ...
    public partial struct Angle : IQuantity<Angle, AngleUnitSelector>
    {
        ...
        public Angle(double value, SelectUnit<AngleUnitSelector> unitSelector)
            : this(value,  UnitBuilder.BuildUnit(unitSelector(new AngleUnitSelector())))
        {
        }
        ...
        public Angle(double value, IUnit unit)
        {
            this.value = value;
            this.Unit = unit;
        }
        ...
        /// </returns>
        public static Angle operator +(Angle quantity)
        {
            return quantity;
        }
        ...
        public static Angle operator -(Angle quantity)
        {
            return new Angle(-quantity.value, quantity.Unit);
        }

        /// <summary>
        /// Increaments the specified <see cref="Angle"/>.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        /// An increamented <see cref="Angle"/>.
        /// </returns>
        public static Angle operator ++(Angle quantity)
        {
            return new Angle(quantity.value + 1, quantity.Unit);
        }

        /// <summary>
        /// Decreaments the specified <see cref="Angle"/>.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        /// An decreamented <see cref="Angle"/>.
        /// </returns>
        public static Angle operator --(Angle quantity)
        {
            return new Angle(quantity.value - 1, quantity.Unit);
        ...
        {
            return new Angle(lhs.value + rhs, lhs.Unit);
        }
        ...
        {
            return new Angle(QuantityOperations.Add(lhs, rhs));
        }
        ...
        public static Angle operator -(Angle lhs, Angle rhs)
        {
            return new Angle(QuantityOperations.Subtract(lhs, rhs));
        }
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="Squared{Angle}"/>.
        /// </returns>
        public Squared<Angle> Squared()
        {
            return new Squared<Angle>(this);
        }
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="Cubed{Angle}"/>.
        /// </returns>
        public Cubed<Angle> Cubed()
        {
            return new Cubed<Angle>(this);
        }
        ...
        /// <summary>
        /// Converts this object to a <see cref="Angle" /> using the specified unit.
        /// </summary>
        /// <param name="unit">The quantity unit.</param>
        /// <returns>
        /// The converted <see cref="Angle" />.
        /// </returns>
        public Angle ToUnit(IUnit unit)
        {
            return new Angle(this.ToDouble(unit), unit);
        }

        /// <summary>
        /// Converts this object to a <see cref="Angle" /> using the unit specified by the <see cref="AngleUnitSelector" />.
        /// </summary>
        /// <param name="unitSelector">The unit selector.</param>
        /// <returns>
        /// The converted <see cref="Angle" />.
        /// </returns>
        public Angle ToUnit(SelectUnit<AngleUnitSelector> unitSelector)
        {
            return this.ToUnit(UnitBuilder.BuildUnit(unitSelector(new AngleUnitSelector())));
        }

        /// <summary>
        /// Converts this object to a <see cref="double" /> using the unit specified by the <see cref="AngleUnitSelector" />.
        /// </summary>
        /// <param name="unitSelector">The unit selector.</param>
        /// <returns>
        /// The converted <see cref="double" />.
        /// </returns>
        public double ToDouble(SelectUnit<AngleUnitSelector> unitSelector)
        {
            return this.ToDouble(UnitBuilder.BuildUnit(unitSelector(new AngleUnitSelector())));
        }
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Angle" />, is equal to this instance.
        /// </summary>
        /// <param name="quantity">The quantity.</param>
        /// <returns>
        ///   <c>true</c> if the specified <see cref="Angle" /> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(Angle quantity)
        {
            return QuantityHelper.AreEqual(this, quantity);
        }
        ...
        {
            return QuantityHelper.CompareTo<Angle>(this, obj);
        }
        ...
        /// A <see cref="Angle" />.
        /// </returns>
        public Angle CreateQuantity(double value, IUnit unit)
        {
        ...
        /// A unit selector.
        /// </returns>
        AngleUnitSelector IQuantity<Angle, AngleUnitSelector>.CreateUnitSelector()
        {
