...
namespace Sundew.Quantities.Generator.UnitSelectors
{
    ...
    public class UnitSelectorGenerator : IGenerator<ICodeSetup, ICodeGeneratorSetup, IProject, IQuantityModel, ITextOutput>
    {
        public IReadOnlyList<IRun> Prepare(ICodeSetup codeSetup, ICodeGeneratorSetup codeGeneratorSetup, IProject target, IQuantityModel model, string modelPath)
        {
            return new[]
            {
                new Run(
                    ...
                    NameHelper.GetFileName($"{model.Name}UnitSelector", codeSetup, codeGeneratorSetup))
            };
        }
