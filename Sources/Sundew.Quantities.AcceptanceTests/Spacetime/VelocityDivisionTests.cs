namespace Sundew.Quantities.AcceptanceTests.Spacetime
{
    ...
    public class VelocityDivisionTests
    {
        ...
        [InlineData(0.0, 0.0, double.NaN)]
        [InlineData(-50.0, 40.0, -1.25)]
        public void Velocity_Division_When_RhsIsLength_Then_ResultShouldBeExpected(double lhs, double rhs, double expected)
        {
            var testee1 = new Velocity(lhs, selector => selector.Meters / selector.Seconds);
        ...
        [InlineData(0.0, 0.0, double.NaN)]
        [InlineData(-50.0, 40.0, -1.25)]
        public void Velocity_Division_When_DividingWithAnyNumber_Then_ResultShouldBeExpected(double lhs, double rhs, double expected)
        {
