namespace Sundew.Quantities.AcceptanceTests.Spatial
{
    ...
    public class DistanceAdditionTests
    {
        ...
        [InlineData(0.0, 0.0, 0.0)]
        [InlineData(-50.0, 40.0, -10.0)]
        public void Distance_Addition_When_AddingAnyNumber_Then_ResultShouldBeExpected(double lhs, double rhs, double expected)
        {
        ...
        public void Distance_Addition_When_PrefixesAreDifferent_Then_ResultShouldBeExpected(double lhs, double rhs, double expected)
        {
        ...
        public void Distance_Addition_When_UnitsAreDifferent_Then_ResultShouldBeAsExpected(double lhs, double rhs, double expected)
        {
